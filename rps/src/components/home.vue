<template>
  <v-app id="inspire" class="bg-color--primary">
    <v-app-bar app clipped-right flat height="50" class="top-bar">
      ...
      <h4 class="ml-5" id="game_name">ROCK PAPER SCISSOR</h4>
      <v-spacer></v-spacer>
      <div style="height: 50px; width: 138px" id="demo_div">
        ...
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title class="v-list-item-title">
              ...
              <div class="mt-4">
                <h5 style="color: yellow">Make Your Choice</h5>
              </div>
              <div class="pb-1" :key="componentKey">
                <div
                  class="mt-4 ml-7 box"
                  style="
                    height: 90px;
                    ...
                    border-radius: 50%;
                    box-shadow: 1px 1px 1px 0.5px cyan;
                  "
                  @click="choice('rock')"
                >
                  <svg
    ...
    >
      <v-list
        ...
        class="pl-5"
      >
        <v-list-item v-for="(item) in left_icon" :key="item.link" link>
          <v-list-item-content style="padding-bottom: 1px">
            <v-list-item-title class="v-list-item-title">
              <div @click="openLeftPanel(item.text)">
                <v-icon style="color: white" class="pl-1 left-icon">{{
    ...
    <div
      v-if="this.is_mobile"
      style="position: absolute; bottom: 80px; z-index: 99"
    >
      <v-list style="background-color: rgba(0, 0, 0, 0.9)">
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title
            ...
            >
              ...
              <div class="ml-15 mt-1" style="color: white">
                <v-text-field
                  dark
                  v-model="amount"
                  label="Amount"
    ...
    <div
      v-if="this.is_mobile"
      style="position: absolute; bottom: 180px; z-index: 99; width: 100%"
    >
      <v-list style="background-color: rgba(0, 0, 0, 0.9)">
        <v-list-item>
          <v-list-item-content>
            <v-list-item-title class="v-list-item-title">
              <div style="color: white">
                <div class="mt-0 mb-n1" v-if="low_fund">
    ...
    >
      ...
      >
        ...
        <v-list-item>
          <v-list-item-content style="padding-bottom: 1px">
            <template>
              <v-card class="history-cards hidden-box" min-width="344" outlined>
                <v-card-title>
                  <span style="zoom: 0.8" class="ml-n3">{{ user.rank }}.</span>
      ...
      >
        ...
        <v-list-item v-for="item in history" :key="item.id">
          <v-list-item-content style="padding-bottom: 1px">
            <template>
              <v-card class="history-cards" min-width="344" outlined>
                <v-card-title>
                  <h5
                    :class="{
                      win: item.result.toLowerCase() === 'win',
                ...
                <v-expand-transition>
                  <div v-show="item.show" class="hidden-box">
                    <v-divider></v-divider>
                    <hr style="border: 0.5px solid silver" />
                    <v-card-text>
                      <div class="row">
...
export default {
  ...
  watch: {
    ...
    "$store.state.history": function (history) {
      this.history = history;
    },
    "$store.state.leaders": function (leaders) {
      this.history = leaders;
    },
  },
};
</script>
