<template>
  <v-app id="inspire" class="bg-color--primary">
    <!-- <v-system-bar app>
      <h4 class="heading">Welcome To Arena</h4>
      <v-spacer></v-spacer>

      <img height="18" src="../assets/icon-rock.svg" alt="Rock" />
      <img
        height="18"
        class="mr-2 ml-2"
        ...
        alt="Paper"
      />
      <img height="18" src="../assets/icon-scissors.svg" alt="Scissor" />
    </v-system-bar> -->
    ...
    <v-app-bar app clipped-right flat height="50" class="top-bar">
      ...
      <v-btn rounded outlined color="teal" dark>
        Play <v-icon right dark> mdi-motion-play </v-icon></v-btn
      >
    </v-app-bar>
          ...
          <v-list-item-content>
            <v-list-item-title class="v-list-item-title">
              ...
              >
                ...
                <div>
                  <v-icon right style="color: #70808c">
                    mdi-information
                  </v-icon>
                </div>
              </div>
              ...
              <div class="mt-12" style="color: white">
                <v-text-field
                  dark
                  disabled
                  v-model="time_left"
              ...
              <div>
                <div
                  class="mt-4 ml-7"
                  style="height: 90px; width: 90px; border: 1px solid white;border-radius:50%"
                >
                  <svg
